...
export const env = {
  ...
  sellingMarginBps: () => { const value = Number(process.env.SELLING_MARGIN_BPS); if (!Number.isInteger(value) || value < 0 || value > 100000) throw new Error("SELLING_MARGIN_BPS must be an integer between 0 and 100000"); return value; },
